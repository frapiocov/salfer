...
<head>
    ...
    <title>Salfer Infissi - Portoni Sezionali</title>
...
<main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            <img src="assets/img/fornitori/Ferraro.jpg" width="200" height="83" class="img-fluid" alt="">
            <h2>Portoni Sezionali</h2>
            <p>La vasta selezione di porte sezionali <b>Salfer</b>: comodit&agrave;, design elegante e
                praticit&agrave; in un unico pacchetto.</p>
        ...
        <div class="container">
            ...
            <div class="row gy-4 m-1" data-aos="fade-up">
                ...
                <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        <a class="nav-link scrollto" href="#astro">
                            <img class="menu-door img-fluid" src="assets/img/sezionali/astro.jpg" alt="1">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        <a class="nav-link scrollto" href="#canova">
                            <img class="menu-door img-fluid" src="assets/img/sezionali/canova.jpg" alt="1">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        <a class="nav-link scrollto" href="#edison">
                            <img class="menu-door img-fluid" src="assets/img/sezionali/edison.png" alt="1">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        <a class="nav-link scrollto" href="#gamma">
                            <img src="assets/img/sezionali/gamma.png" alt="1" class="img-fluid menu-door">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        <a class="nav-link scrollto" href="#lennox">
                            <img src="assets/img/sezionali/lennox.png" alt="1" class="img-fluid menu-door">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        <a class="nav-link scrollto" href="#light">
                            <img src="assets/img/sezionali/light.jpg" alt="1" class="img-fluid menu-door">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        <a class="nav-link scrollto" href="#magic">
                            <img src="assets/img/sezionali/magic.png" alt="1" class="img-fluid menu-door">
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box text-center">
                        <a class="nav-link scrollto" href="#master">
                            <img src="assets/img/sezionali/master.png" alt="1" class="img-fluid menu-door">
                        </a>
                    </div>
                </div>
            ...
            <!--astro-->
            <div class="row gy-4 section-bg m-1" id="astro" data-aos="fade-up">
                <div class="col-lg-7">
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/astro1.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/astro2.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="portfolio-info">
                        <h2 style="color: #0c3c53">Astro</h2>
            ...
            <!--canova-->
            <div class="row gy-4 m-1" id="canova" data-aos="fade-up">

                <div class="col-lg-5">
                    <div class="portfolio-info">
                        <h2 style="color: #0c3c53">Canova</h2>
                        <h3>Informazioni tecniche prodotto</h3>
                        <p>
                            ...
                            l'Okoum&egrave; e, a richiesta, altre essenze; <b>vengono opportunamente trattati</b>
                            per essere collocati all'esterno.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/canova1.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/canova2.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/canova3.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/canova4.jpg" alt="">
                            </div>
                        </div>
                        <div class="swiper-pagination"></div>
                    </div>
            ...
            <!--edison-->
            <div class="row gy-4 section-bg m-1" id="edison" data-aos="fade-up">
                <div class="col-lg-7">
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/edison1.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/edison2.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/edison3.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="portfolio-info">
                        <h2 style="color: #0c3c53">Edison</h2>
                        <h3>Informazioni tecniche prodotto</h3>
                        <p>
            ...
            <!--gamma-->
            <div class="row gy-4 m-1" id="gamma" data-aos="fade-up">

                <div class="col-lg-5">
                    <div class="portfolio-info">
                        <h2 style="color: #0c3c53">Gamma</h2>
                        <h3>Informazioni tecniche prodotto</h3>
                        <p>
                            Il modello Gamma, apparentemente simile al Master, propone un giunto di accoppiamento
                ...
                <div class="col-lg-7">
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/gamma1.jpg" alt="">
                            </div>
                        </div>
                        <div class="swiper-pagination"></div>
                    </div>
            ...
            <!--lennox-->
            <div class="row gy-4 section-bg m-1" id="lennox" data-aos="fade-up">
                <div class="col-lg-7">
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/lennox1.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/lennox2.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/lennox3.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/lennox4.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="portfolio-info">
                        <h2 style="color: #0c3c53">Lennox</h2>
                        <h3>Informazioni tecniche prodotto</h3>
                        <p>
                            Lennox è il modello più richiesto della collezione Genius.
                            Questo senza ombra di dubbio &egrave; dovuto alla sobriet&agrave; del disegno
            ...
            <!--light-->
            <div class="row gy-4 m-1" id="light" data-aos="fade-up">

                <div class="col-lg-5">
                    <div class="portfolio-info">
                        <h2 style="color: #0c3c53">Light</h2>
                        <h3>Informazioni tecniche prodotto</h3>
                        <p>
                            Quando la luce all'interno del garage o dell'autosalone
                            &egrave; un'esigenza, quando <b>l'areazione</b> all'interno del box
                            ...
                            di lamiera del modello che pi&ugrave; si preferisce.
                            Novit&agrave; : a richiesta i profili di alluminio possono essere esternamente
                            plastificati finto legno ed internamente verniciati bianco Ral 9010.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/light1.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/light2.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/light3.jpg" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/light4.jpg" alt="">
                            </div>
            ...
            <!--magic-->
            <div class="row gy-4 section-bg m-1" id="magic" data-aos="fade-up">
                <div class="col-lg-7">
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/magic1.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/magic2.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/magic3.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="portfolio-info">
                        <h2 style="color: #0c3c53">Magic</h2>
                        <h3>Informazioni tecniche prodotto</h3>
                        <p>
                            Il modello Magic, per la sua particolare <b>estetica caratterizzata dall'alternarsi
                                di doghe di altezze diverse</b>, &egrave; unico nel suo genere in quanto
                            i pannelli presentano una riga longitudinale decentrata e ben marcata.
                            A portone chiuso, si apprezza l'asimmetricità dei dogoni alti cm 35
                            che si alternano alle doghe di cm 15.
                            Per la sua particolare estetica, <b>mette in risalto soprattutto con i colori legno</b>,
                            Magic &egrave; <b>consigliato nelle aree di montagna</b> dove sovente viene richiesta questa
                            particolarit&egrave; architettonica, nel rispetto della tradizione di quei luoghi.
                        </p>
                    </div>
                </div>
            </div>
            <!--master-->
            <div class="row gy-4 m-1" id="master" data-aos="fade-up">
                ...
                <div class="col-lg-7">
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/master1.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/maste2.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/master3.jpg" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/sezionali/master4.jpg" alt="">
                            </div>
